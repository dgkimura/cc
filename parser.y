...
external_declaration:
    function_definition { $$ = create_external_declaration($1, NULL); } |
    declaration { $$ = create_external_declaration(NULL, $1); }
    ;
